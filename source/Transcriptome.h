...
public:
    ...
    uint32 quantAlign (Transcript &aG, Transcript *aTall, vector<uint32> &alignTranscripts);//transform coordinates for all aligns from genomic in RA to transcriptomic in RAtr
