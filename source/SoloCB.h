...
public:
    ...
    struct {
        enum {nNoGene,nAmbigGene,nAmbigGeneMultimap,nNinBarcode,nUMIhomopolymer,nTooMany,nNoMatch,nExactMatch,nMatch,nStats};
        uint64 V[nStats];
        vector<string> names={"nNoGene","nAmbigGene","nAmbigGeneMultimap","nNinBarcode","nUMIhomopolymer","nTooMany","nNoMatch","nExactMatch","nMatch"};
    } stats;
    
    uint32 homoPolymer[4];
