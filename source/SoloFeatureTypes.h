...
//     const static vector<string> Names={"Gene","GeneFull","SJ","Transcript3p","VelocytoSpliced","VelocytoUnspliced","VelocytoAmbiguous",};
    enum {SJ=0, Transcript3p=1, GeneFull=2, GeneFull_ExonOverIntron=3, GeneFull_CR=4, Gene=5, VelocytoSimple=6, Velocyto=7, N=8};
    const static vector<string> Names={"SJ", "Transcript3p", "GeneFull", "GeneFull_ExonOverIntron", "GeneFull_CR", "Gene", "VelocytoSimple", "Velocyto"};
};
