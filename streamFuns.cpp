...
void openOfstream (std::string fileName, std::string errorID, Parameters *P, ofstream & ofStream) {//open file 'fileName', generate error if cannot open
...
//         if (dir1=="") dir1="./";
        ...
        exitWithError(errOut.str(),std::cerr, P->inOut->logMain, EXIT_CODE_OPEN_FILE, *P);
    };    
};
